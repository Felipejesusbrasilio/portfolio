  ...
  .then(data => {
    let body = document.getElementById('getPageModal');
    console.log(body);
    body.innerHTML = data;
  ...
  if (divClose) {
    ...
    // Agora que o conteúdo foi carregado, podemos executar a função
    let boxs = document.querySelectorAll('.box'); // Recarregar a seleção
...
removerCaixas();
  ...
  .catch(error => {
    console.log('Houve um erro ao fazer o request: ', error.message);
  });
